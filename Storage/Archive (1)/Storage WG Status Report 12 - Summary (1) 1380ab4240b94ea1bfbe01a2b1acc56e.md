# Storage WG Status Report 12 - Summary (1)
...
|  | **Work Hours** |
| --- | --- |
| Worker ID 0 - Lead (0x2bc) | 20 |
| Worker ID 1 (joystreamstats) |  |
| Worker ID 2 (alexznet) | 1 |
| Worker ID 3 (maxlevush) | 5 |
| Worker ID 4 (l1dev) |  |
| Worker ID 5 (GodsHunter) |  |
| Worker ID 7 - Deputy Lead (yyagi) | 40 |
| Worker ID 8 (mmx1916) |  |
| Worker ID 9 (Craci_BwareLabs) | 5 |
| Worker ID 10 (razumv) |  |
| Worker ID 111 (sieemma) | 24 |
...
- Filled some information about the emergency_score  (see the full report)
