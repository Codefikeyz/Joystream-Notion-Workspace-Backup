...
- Keep improving the “Elastic Report System” ([LOGGING_SCORE](https://joystream.gitbook.io/testnet-workspace/testnet/council-period-scoring/storage-providers-score#logging_score))
    ...
    ![Untitled](../Archive/Storage%20WG%20Status%20Report%2013%20-%20Summary%20(1)/Untitled.png)
...
![Untitled](../Archive/Storage%20WG%20Status%20Report%2013/Untitled.png)
...
- What data objects were permanently lost, and if any, why.
    ...
    [Permanently lost objects](Storage%20WG%20Status%20Report%2013/Permanently%20lost%20objects%20a40d65526b894728b27a889d755ec438.csv)
...
- A chart (with raw data available for future use) that plots the changes in the values below over the council period, through snapshots at every 600 block:
    ...
    ![Untitled](../Archive/Storage%20WG%20Status%20Report%2013/Untitled%202.png)
    
- amount of bags;
    - Total amount of bags: **642**
    
    ![Untitled](../Archive/Storage%20WG%20Status%20Report%2013/Untitled%203.png)
    
- (average) number and size of data objects in a bag

[(average) number and size of data objects in a bag](Storage%20WG%20Status%20Report%2013/(average)%20number%20and%20size%20of%20data%20objects%20in%20a%20bag%20edf7c733679941aaa21a667662e9fded.csv)
