...
*Members apply for approved bounties in the [Bounties Application thread](https://pioneerapp.xyz/#/forum/thread/808) with the number code, following the application process in [Section 2.](Community%20Guidelines%20c6e4619bc29e44c7986b778ef9e6eeee.md)* 

**NOTE: Approved Bounties for Application can be [found here](https://github.com/Codefikeyz/Joystream_HR/tree/main/Bounties)**

**Phase 6: Bounty Assignment**

*HR assigns bounty to qualified individuals within a specified period, as per qualification criteria in [Section 3.](Community%20Guidelines%20c6e4619bc29e44c7986b778ef9e6eeee.md)*

**Phase 7: Bounty Execution**

*Bounties assigned go into the execution process and will be updated in the [Bounties page here](https://github.com/Codefikeyz/Joystream_HR/tree/main/Bounties)*

**Phase 8: Progress Monitoring**

*Bounties are executed within the assigned ETA, and milestones are reported to HR for documentation on [Github](https://github.com/Codefikeyz/Joystream_HR/tree/main/Bounties) and [Notion.](Approved%20Bounties%207c56d9689ab34904b45f3e365b0ecb83.md)*
