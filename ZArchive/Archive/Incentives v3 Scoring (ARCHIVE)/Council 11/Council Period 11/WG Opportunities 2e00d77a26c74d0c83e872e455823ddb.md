...
```markdown
yarn joystreyarn joystream-cli incentives:getOpportunitiesScore -c incentives:getOpportunitiesScore -c storageProviders,curators,forum,builders,humanResources,distributors,marketing -e 1152000 -l 100800 -s 43200 -t 20,20,20,20,20,20,20
-> 
