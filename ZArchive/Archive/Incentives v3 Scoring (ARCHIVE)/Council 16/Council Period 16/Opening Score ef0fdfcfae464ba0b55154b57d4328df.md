...
- Cancelled quickly
**11**
- 1099208-1244327 (cancelled)
- 0 applicants

* No "downtime" without any openings, even just after filling or closing the old one
  * (100800-979)/100800 = 0.9902876984
* Quality of opening (16 only evaluated), in terms of information, requests and questions
  * Good descriptions
...
* Inquires and applications dealt with in a reasonable time and manner
  * Slow response to requests, but not during said term
    * 1
